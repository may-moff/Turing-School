...
# UnitConverter.new.convert(2, :cup, :gram) #dimensions mismatch error!

DimensionalMismatchError = Class.new(StandardError)

Quantity = Struct.new(:amount, :unit)
#structs are simple ruby classes that provides getters and setters
...
describe UnitConverter do
  describe "#convert" do
    ...
    it "can convert two quantities of the same unit" do
      cups = Quantity.new(2, :cup)
    ...
    it "raises an error if the two quantities are of different dimensons" do
      cups = Quantity.new(2, :cup)
